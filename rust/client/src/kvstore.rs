...
impl SetResponse {
  pub fn new<F2, F3>(success: bool, error: F2, error_code: F3) -> SetResponse where F2: Into<Option<String>>, F3: Into<Option<String>> {
    SetResponse {
      success,
      error: error.into(),
...
impl DeleteResponse {
  pub fn new<F2, F3>(success: bool, error: F2, error_code: F3) -> DeleteResponse where F2: Into<Option<String>>, F3: Into<Option<String>> {
    DeleteResponse {
      success,
      error: error.into(),
      error_code: error_code.into(),
...
pub struct FaultInjectionRequest {
  ...
  pub probability: Option<OrderedFloat<f64>>,
  pub duration_ms: Option<i32>,
  pub target_operation: Option<String>,
}

impl FaultInjectionRequest {
  pub fn new<F2, F3, F4>(fault_type: String, probability: F2, duration_ms: F3, target_operation: F4) -> FaultInjectionRequest where F2: Into<Option<OrderedFloat<f64>>>, F3: Into<Option<i32>>, F4: Into<Option<String>> {
    FaultInjectionRequest {
      fault_type,
  ...
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<FaultInjectionRequest> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<String> = None;
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("FaultInjectionRequest.fault_type", &f_1)?;
    let ret = FaultInjectionRequest {
      fault_type: f_1.expect("auto-generated code should have checked for presence of required fields"),
      probability: f_2,
      duration_ms: f_3,
      target_operation: f_4,
    };
    Ok(ret)
  }
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("FaultInjectionRequest");
    o_prot.write_struct_begin(&struct_ident)?;
    o_prot.write_field_begin(&TFieldIdentifier::new("fault_type", TType::String, 1))?;
    o_prot.write_string(&self.fault_type)?;
    o_prot.write_field_end()?;
    if let Some(fld_var) = self.probability {
      o_prot.write_field_begin(&TFieldIdentifier::new("probability", TType::Double, 2))?;
      o_prot.write_double(fld_var.into())?;
      o_prot.write_field_end()?
    }
    if let Some(fld_var) = self.duration_ms {
      o_prot.write_field_begin(&TFieldIdentifier::new("duration_ms", TType::I32, 3))?;
      o_prot.write_i32(fld_var)?;
      o_prot.write_field_end()?
    }
    if let Some(ref fld_var) = self.target_operation {
      o_prot.write_field_begin(&TFieldIdentifier::new("target_operation", TType::String, 4))?;
      o_prot.write_string(fld_var)?;
      o_prot.write_field_end()?
    }
    o_prot.write_field_stop()?;
...
#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
pub struct FaultInjectionResponse {
  pub success: bool,
  pub error: Option<String>,
}

impl FaultInjectionResponse {
  pub fn new<F2>(success: bool, error: F2) -> FaultInjectionResponse where F2: Into<Option<String>> {
    FaultInjectionResponse {
      success,
      error: error.into(),
    }
  }
  pub fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<FaultInjectionResponse> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<bool> = None;
    let mut f_2: Option<String> = None;
    loop {
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("FaultInjectionResponse.success", &f_1)?;
    let ret = FaultInjectionResponse {
      success: f_1.expect("auto-generated code should have checked for presence of required fields"),
      error: f_2,
    };
    Ok(ret)
  ...
  pub fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("FaultInjectionResponse");
    o_prot.write_struct_begin(&struct_ident)?;
    o_prot.write_field_begin(&TFieldIdentifier::new("success", TType::Bool, 1))?;
    o_prot.write_bool(self.success)?;
    o_prot.write_field_end()?;
...
pub trait TTransactionalKVSyncClient {
  ...
  fn set_fault_injection(&mut self, request: FaultInjectionRequest) -> thrift::Result<FaultInjectionResponse>;
...
impl <C: TThriftClient + TTransactionalKVSyncClientMarker> TTransactionalKVSyncClient for C {
  ...
  fn set_fault_injection(&mut self, request: FaultInjectionRequest) -> thrift::Result<FaultInjectionResponse> {
    (
      {
        self.increment_sequence_number();
        let message_ident = TMessageIdentifier::new("setFaultInjection", TMessageType::Call, self.sequence_number());
        let call_args = TransactionalKVSetFaultInjectionArgs { request };
        self.o_prot_mut().write_message_begin(&message_ident)?;
        call_args.write_to_out_protocol(self.o_prot_mut())?;
        self.o_prot_mut().write_message_end()?;
        self.o_prot_mut().flush()
    ...
    )?;
    {
      let message_ident = self.i_prot_mut().read_message_begin()?;
      verify_expected_sequence_number(self.sequence_number(), message_ident.sequence_number)?;
      verify_expected_service_call("setFaultInjection", &message_ident.name)?;
      if message_ident.message_type == TMessageType::Exception {
        let remote_error = thrift::Error::read_application_error_from_in_protocol(self.i_prot_mut())?;
        self.i_prot_mut().read_message_end()?;
        return Err(thrift::Error::Application(remote_error))
      ...
      verify_expected_message_type(TMessageType::Reply, message_ident.message_type)?;
      let result = TransactionalKVSetFaultInjectionResult::read_from_in_protocol(self.i_prot_mut())?;
      self.i_prot_mut().read_message_end()?;
      result.ok_or()
    }
  }
...
pub trait TransactionalKVSyncHandler {
  ...
  fn handle_set_fault_injection(&self, request: FaultInjectionRequest) -> thrift::Result<FaultInjectionResponse>;
...
impl <H: TransactionalKVSyncHandler> TransactionalKVSyncProcessor<H> {
  ...
  fn process_set_fault_injection(&self, incoming_sequence_number: i32, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    TTransactionalKVProcessFunctions::process_set_fault_injection(&self.handler, incoming_sequence_number, i_prot, o_prot)
  }
...
impl TTransactionalKVProcessFunctions {
  ...
  pub fn process_set_fault_injection<H: TransactionalKVSyncHandler>(handler: &H, incoming_sequence_number: i32, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let args = TransactionalKVSetFaultInjectionArgs::read_from_in_protocol(i_prot)?;
    match handler.handle_set_fault_injection(args.request) {
      Ok(handler_return) => {
        let message_ident = TMessageIdentifier::new("setFaultInjection", TMessageType::Reply, incoming_sequence_number);
        o_prot.write_message_begin(&message_ident)?;
        let ret = TransactionalKVSetFaultInjectionResult { result_value: Some(handler_return) };
        ret.write_to_out_protocol(o_prot)?;
        o_prot.write_message_end()?;
        o_prot.flush()
      },
      Err(e) => {
        match e {
          thrift::Error::Application(app_err) => {
            let message_ident = TMessageIdentifier::new("setFaultInjection", TMessageType::Exception, incoming_sequence_number);
            o_prot.write_message_begin(&message_ident)?;
            thrift::Error::write_application_error_to_out_protocol(&app_err, o_prot)?;
            o_prot.write_message_end()?;
            o_prot.flush()
...
impl <H: TransactionalKVSyncHandler> TProcessor for TransactionalKVSyncProcessor<H> {
  fn process(&self, i_prot: &mut dyn TInputProtocol, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    ...
    let res = match &*message_ident.name {
      ...
      "setFaultInjection" => {
        self.process_set_fault_injection(message_ident.sequence_number, i_prot, o_prot)
      },
      "ping" => {
...
//
// TransactionalKVSetFaultInjectionArgs
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct TransactionalKVSetFaultInjectionArgs {
  request: FaultInjectionRequest,
}

impl TransactionalKVSetFaultInjectionArgs {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TransactionalKVSetFaultInjectionArgs> {
    i_prot.read_struct_begin()?;
    let mut f_1: Option<FaultInjectionRequest> = None;
    loop {
      let field_ident = i_prot.read_field_begin()?;
      if field_ident.field_type == TType::Stop {
        break;
      ...
      match field_id {
        1 => {
          let val = FaultInjectionRequest::read_from_in_protocol(i_prot)?;
          f_1 = Some(val);
        },
        _ => {
          i_prot.skip(field_ident.field_type)?;
    ...
    i_prot.read_struct_end()?;
    verify_required_field_exists("TransactionalKVSetFaultInjectionArgs.request", &f_1)?;
    let ret = TransactionalKVSetFaultInjectionArgs {
      request: f_1.expect("auto-generated code should have checked for presence of required fields"),
    };
    Ok(ret)
  }
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("setFaultInjection_args");
    o_prot.write_struct_begin(&struct_ident)?;
    o_prot.write_field_begin(&TFieldIdentifier::new("request", TType::Struct, 1))?;
    self.request.write_to_out_protocol(o_prot)?;
    o_prot.write_field_end()?;
...
//
// TransactionalKVSetFaultInjectionResult
//

#[derive(Clone, Debug, Eq, Hash, Ord, PartialEq, PartialOrd)]
struct TransactionalKVSetFaultInjectionResult {
  result_value: Option<FaultInjectionResponse>,
}

impl TransactionalKVSetFaultInjectionResult {
  fn read_from_in_protocol(i_prot: &mut dyn TInputProtocol) -> thrift::Result<TransactionalKVSetFaultInjectionResult> {
    i_prot.read_struct_begin()?;
    let mut f_0: Option<FaultInjectionResponse> = None;
    loop {
      let field_ident = i_prot.read_field_begin()?;
      if field_ident.field_type == TType::Stop {
        break;
      ...
      match field_id {
        0 => {
          let val = FaultInjectionResponse::read_from_in_protocol(i_prot)?;
          f_0 = Some(val);
        },
        _ => {
          i_prot.skip(field_ident.field_type)?;
    ...
    i_prot.read_struct_end()?;
    let ret = TransactionalKVSetFaultInjectionResult {
      result_value: f_0,
    };
    Ok(ret)
  }
  fn write_to_out_protocol(&self, o_prot: &mut dyn TOutputProtocol) -> thrift::Result<()> {
    let struct_ident = TStructIdentifier::new("TransactionalKVSetFaultInjectionResult");
    o_prot.write_struct_begin(&struct_ident)?;
    if let Some(ref fld_var) = self.result_value {
      o_prot.write_field_begin(&TFieldIdentifier::new("result_value", TType::Struct, 0))?;
      fld_var.write_to_out_protocol(o_prot)?;
  ...
  fn ok_or(self) -> thrift::Result<FaultInjectionResponse> {
    if self.result_value.is_some() {
      Ok(self.result_value.unwrap())
    } else {
      Err(
        thrift::Error::Application(
          ApplicationError::new(
            ApplicationErrorKind::MissingResult,
            "no result received for TransactionalKVSetFaultInjection"
          )
        )
      )
    }
